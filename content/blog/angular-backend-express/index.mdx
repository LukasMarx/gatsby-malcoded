...
[Try GraphQL with Angular Apollo & Express instead!]([object Object])

Not a fan of Node.js backends?
[Then this guide to building a REST-API with ASP.Core is for you!]([object Object])
...
To run a node.js application, we have to install node.js on our machine first. You can download it at the [official node.js website]([object Object]). For this tutorial, it does not matter, which version you choose. If you want to be on the save side, choose the long-term-support version (LTS). 
...
Enabling CORS
The first thing I realize, when I want to test my brand new API with my angular app, is, that I forgot to enable [CORS]([object Object]).
...
If you feel like you are lacking knowledge in one or both of the mentioned things, I recommend you read my [Angular Beginners Guide ]([object Object])first.
...
For that, we are using the angular HttpClient. So you need to import the HttpClientModule into a [module ]([object Object])of your choice, but typically the App-Module.
