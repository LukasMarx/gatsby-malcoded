...
Want to build a node.js backend instead? Check out my tutorial [Building a REST-Backend for Angular with Node.js & Express]([object Object])!
![angular-cli](./img/angular-cli.png)

## Setting up an ASP.NET Core 2.0 Project

First of all, we need to download and install the dotnet SDK. You can download it at the [official page]([object Object]).
...
These services can then be requested via [dependency injection]([object Object]) in our classes constructors.
