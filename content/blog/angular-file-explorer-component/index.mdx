...
In this tutorial, we are going to use the [angular material library]([object Object]). This library provides a set of UI-components that follow [google's material design paradigm]([object Object]) and therefore look just awesome.
...
To achieve that, everything is handled via [@Inputs]([object Object]) and [@Outputs]([object Object]). All the component does is receive an array of FileElements and display them. Once the user takes action, the component fires an event to notify the parent component.
...
[Learn more about angular material menus!]([object Object])
...
Of course you can look up the full source code at the corresponding [GitHub repository]([object Object]).
