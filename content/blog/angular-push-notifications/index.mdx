...
To interact with our service worker and request a subscription, angular provides a service called [SwPush]([object Object]). To get access to this service we request it in the constructor of the component via [dependency injection]([object Object]).
...
export class AppComponent {
 ...
 ``` 
This method returns a promise that resolves to a [PushSubscription ]([object Object])object. This subscription contains all the information that we need to send push notification to the client.
...
If you want to see the full code, take a look at the [GitHub repository]([object Object]).
