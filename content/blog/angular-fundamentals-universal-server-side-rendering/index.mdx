...
[Angular Universal]([object Object]) once was a standalone project. Its main purpose was, to enable angular to run angular completely platform independent.
...
First, we need to create two additional modules in the applications app directory. Next to app.module.ts create a file named browser.app.module.ts and a file named server.app.module.ts. If you want to learn more about modules, check out this [article about angular modules]([object Object])!
...
To do the server side rendering itself, we are going to use an external package, I mentioned earlier. This package is called [@nguniversal/express-engine]([object Object]). To install it, use one of the following commands.
...
npm install @nguniversal/express-engine --save
 ...
 ``` 
Of course, we also require [express ]([object Object])itself.
...
Note: I assume, that you already have an angular application that is using lazy-loading. If you don’t know how you can utilize lazy-loading, you should check out this [great article from rangle.io about lazy-loading modules]([object Object]).
...
Now that we have set everything up, we can use the transfer state API by requesting an instance of the service via [dependency injection]([object Object]). For this example, we are using a component called post.component.
