...
onDragLeave(event: DragEvent): void {
 ...
 ``` 
Last but not least, there are the onDrop and the onFileChanged callbacks. Both receive a [FileList]([object Object]) and both convert that FileList into a normal array.
...
This method is returning a [promise]([object Object]). We collect the promise for each file-upload in an array called promises.
...
This method is taking a file as input. It then creates a new [XMLHttpRequest]([object Object]) and appends the file to a [FormData]([object Object]) object. Before we then send the request to the server, we are registering a bunch of event listeners.
...
Don't worry, take a look at the [GitHub Repository]([object Object])!
