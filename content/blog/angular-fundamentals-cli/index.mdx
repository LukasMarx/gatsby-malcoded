---
title: Angular CLI: The best Commands to boost your productivity
...
Whether you agree to that sentence or not, you will probably agree with me, that angular projects consist of a bunch of files.

Setting up a new project and creating all these files for every new component can take a lot of time. It also takes a lot of fun from the development process.

Fortunately, there are tools like the angular-cli, that can do all that hard work for you!

In this angular cli tutorial, we are going to take a look at the angular-cli and how to use it properly.

We will discover all the different things the CLI can do for you, to take a lot of the work away from you, to let you concentrate on the actual task:

Developing a angular application!
...
To use the [angular-cli]([object Object]), we need to install it first. 
...
Skipping the Installation of External Dependencies
...
Using pre-processed Css like [Sass ]([object Object])has become quite popular.
...
But not only Sass-files (.scss) are supported. You can find a list of all supported style-extensions at the [official angular-cli-wiki]([object Object]).
...
This means, that certain optimizations where not performed and the app is still using the development[ environment variables]([object Object]).
